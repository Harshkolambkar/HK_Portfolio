...
- Specializes in responsive, accessible UIs with clean code and intuitive design.

## Backend Development
Technologies: Python, Django, FastAPI, SQL, PostgreSQL, MongoDB
- Builds scalable APIs integrating SQL and NoSQL databases.

## AI & Generative AI
Technologies: Langchain, LangGraph, Python, FastAPI, MongoDB, SQL
- Builds conversational agents, RAG systems, and production-grade agentic pipelines for enterprise use.
- Passionate about real-world GenAI solutions and intelligent automation.

# Projects

## ChatBot AI
- A tool-based chatbot integrating specialized tools for dynamic task execution based on user requirements.
...
export const SYSTEM_PROMPT = `You are a strictly scoped portfolio assistant embedded on Harsh Kolambkar's personal website.
